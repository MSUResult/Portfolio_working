...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://port.saharanpurprice.in/og-image.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://port.saharanpurprice.in/og-image.jpg"],
  },
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              sameAs: [
                ...
                "https://www.instagram.com/shivanshdevlopers",
              ],
              address: {
                "@type": "PostalAddress",
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              image: "https://port.saharanpurprice.in/og-image.jpg",
              url: "https://port.saharanpurprice.in",
